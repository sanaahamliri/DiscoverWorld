...
<body>
    ...
    <div class="container flex">
        <section class="grid md:grid-cols-2 xl:grid-cols-2 gap-6" style="margin-left: 100px; margin-top: 100px">
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500"><b>le nombre d'utilisateurs actifs</b> <br> 50 user</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500"> <b>le nombre total d'aventures </b> <br> 70 aventures</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    <span class="block text-2xl font-bold"></span>
                    <span class="block text-gray-500"><b>les destinations les plus populaires</b>  <br> 11 Destination</span>
                </div>
            </div>
        </section>
    </div>
